...
/*
  ## Summary:
  Searching algorithm that allows you to search for a target within the array or
  list in logarithmic time complexity. Array or list needs to be sorted in asc
  order.
*/
...
/*
  ## Summary:
  Searching algorithm that allows you to search for a target within the array or
  list in linear time complexity. Array or list does not need to be sorted
  because the algorithm traverses through the entire array or list. It is
  important to note that the time complexity is dependent on N.
*/
