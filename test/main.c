...
void test_binary_search_i16(void) {
  ...
  */
  ...
  const int16_t test_arrays[ARRAY_TEST_CASE_SIZE][9] = {
      ...
      {1, 2, 3, 4, 500, 4444, 8000, 8500, 8700},
      {1, 2, 3, 4, 500, 4444, 8000, 8500, 8700}};
  const int16_t test_arrays_targets[ARRAY_TEST_CASE_SIZE] = {8500, 4444, 500};
  const int16_t test_arrays_result[ARRAY_TEST_CASE_SIZE] = {7, 5, 4};
  // ==============================================
...
void test_binary_search_i32(void) {
  ...
  */
  ...
  const int32_t test_arrays[ARRAY_TEST_CASE_SIZE][9] = {
      ...
      {1, 2, 3, 4, 500, 4444, 8000, 8500, 8700},
      {1, 2, 3, 4, 500, 4444, 8000, 8500, 8700}};
  const int32_t test_arrays_targets[ARRAY_TEST_CASE_SIZE] = {8500, 4444, 500};
  const int32_t test_arrays_result[ARRAY_TEST_CASE_SIZE] = {7, 5, 4};
  // ==============================================
  for (size_t i = 0; i < ARRAY_TEST_CASE_SIZE; i++) {
...
void test_binary_search_i64(void) {
  ...
  */
  ...
  const int64_t test_arrays[ARRAY_TEST_CASE_SIZE][9] = {
      ...
      {1, 2, 3, 4, 500, 4444, 8000, 8500, 8700},
      {1, 2, 3, 4, 500, 4444, 8000, 8500, 8700}};
  const int64_t test_arrays_targets[ARRAY_TEST_CASE_SIZE] = {8500, 4444, 500};
  const int64_t test_arrays_result[ARRAY_TEST_CASE_SIZE] = {7, 5, 4};
  // ==============================================
  for (size_t i = 0; i < ARRAY_TEST_CASE_SIZE; i++) {
...
void test_linear_search_i16(void) {
  ...
  const int16_t test_inputs[TEST_INPUT_SIZE][9] = {
      ...
      {344, 44, 54, 66, 56, 7, 45, 99, 22},
      {344, 44, 54, 66, 56, 7, 45, 99, 22}};
  const int16_t test_targets[TEST_INPUT_SIZE] = {100, 99, 22};
  const int16_t test_expected_results[TEST_INPUT_SIZE] = {-1, 7, 8};
  for (size_t i = 0; i < TEST_INPUT_SIZE; i++) {
    const int16_t result = linear_search_i16(
        test_inputs[i], sizeof(test_inputs[i]) / sizeof(test_inputs[i][0]),
        test_targets[i]);
...
void test_quick_sort_i32(void) {
  ...
  const int32_t test_inputs[TEST_CASE_SIZE][TEST_CASE_INPUT_SIZE] = {
      {344, 44, 54, 66, 56, 7, 45, 99, 22},
      {344, 44, 54, 66, 56, 7, 45, 99, 22},
      {344, 44, 54, 66, 56, 7, 45, 99, 22}};
  const int32_t test_expected_results[TEST_CASE_SIZE][TEST_CASE_INPUT_SIZE] = {
      {7, 22, 44, 45, 54, 56, 66, 99, 344},
      {7, 22, 44, 45, 54, 56, 66, 99, 344},
      {7, 22, 44, 45, 54, 56, 66, 99, 344}};
  for (size_t i = 0; i < TEST_CASE_SIZE; i++) {
    quick_sort_i32(test_inputs[i], 0,
                   sizeof(test_inputs[i]) / sizeof(test_inputs[i][0]) - 1);
    for (size_t j = 0; j < TEST_CASE_INPUT_SIZE; j++) {
      TEST_ASSERT_EQUAL(test_expected_results[i][j], test_inputs[i][j]);
    }
  }
}
